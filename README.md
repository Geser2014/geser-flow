...
Легковесное Windows-приложение для учёта рабочего времени по проектам и этапам.
...
- **Проекты и этапы** — иерархическая структура: проект содержит этапы, время учитывается на обоих уровнях
- **Удобный выбор** — выпадающие списки проектов и этапов, последний использованный выбирается автоматически
- **Создание на лету** — новый проект или этап прямо из главного окна
...
- **Дашборд** — статистика по проектам с раскрытием этапов, круговая диаграмма распределения времени, фильтрация по периоду и экспорт в CSV
- **Удаление** — правый клик по проекту или этапу в дашборде для удаления с подтверждением
